...
public class DonorReport {
    ...
    public int readFile() {
       ...
       try {
            // read csv file && check if the file exists
            BufferedReader br = new BufferedReader(new FileReader("Report Formatting - Scholarship Report.csv"));
            //check if the file has been modified & size MD5CheckSum
            br.readLine(); // don't process header && encrypts //possible error GUI
